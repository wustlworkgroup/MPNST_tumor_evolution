...
library(dplyr)
Data_fileter_bin=Data_filter[,c("Chromosome","Start","End","RDR","BAF")]%>%dplyr::filter(BAF>0.45&RDR<1.45)%>%
...
#Bandwidth_RDR=
Out=density_with_hdi (Data_fileter_bin$RDR,bandwidth = 0.03, credMass = 0.9)

---
title: "`r paste0(config::get(file = 'Step1_config.yml')$PT_ID, '_data_curation')`"
...
#create a folder for PT_ID in Process_path here
dir.create(paste0(Process_path,"/",PT_ID))


if (! file.exists(file.path(paste0(Process_path,"/",PT_ID),paste0(PT_ID,"_Germline_somatic_RD_BAF.rdata")))) {

 
 
  save(PT_Sample_info,Germline_CNV,Somatic_CNV,file=file.path(paste0(Process_path,"/",PT_ID),paste0(PT_ID,"_Germline_somatic_RD_BAF.rdata")))
}
```
